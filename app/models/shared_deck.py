...
class TemplateSet(Base, BaseTableMixin):
    ...
    meta: Mapped[dict | None] = mapped_column(JSON, nullable=True, comment="元数据（是否支持暗色模式等）")
    is_official: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, comment="是否官方主题")
