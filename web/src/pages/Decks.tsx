...
import { Folder, BookOpen, Loader2, Trash2, MoreVertical, Edit, Download } from 'lucide-react'
      ...
      {loading ? (
        ...
        <Empty className="border rounded-lg py-16">
          <EmptyHeader>
            ...
            <EmptyDescription>从牌组市场导入共享牌组开始学习</EmptyDescription>
          </EmptyHeader>
          <EmptyContent>
            <Button asChild>
              <Link to="/market">
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <Badge variant={stats.new > 0 ? 'default' : 'secondary'}>新 {stats.new}</Badge>
                  ...
                  <div className="text-sm text-muted-foreground">共 {stats.total} 张卡片</div>
      ...
      <Dialog open={renameDialogOpen} onOpenChange={setRenameDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>为您的牌组设置一个新名称</DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <Input
              placeholder="输入新名称"
